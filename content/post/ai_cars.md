...
<!--more-->
In the past few years, AI (Artificial Intelligence) entered everyday conversations as both the boon and bane for our futures.
<!-- s -->
...
<!-- s -->
We also aims to engage readers in shaping the goals and approaches to humanising machine intelligence (MI) through a familiar machine.
...
<!-- s -->
Take, for example, steam engines had a revival in the 1950s when nuclear power became available for industrial use.
<!-- s -->
...
<!-- s -->
What this implies is that students of machine learning should aim to build a broad foundation of different mathematical tools and decision-making paradigms, to be able to adapt and propel to the technology shifts in the future.
...
<!-- s -->
The technical community are working hard on common components and reusable systems, one may wonder what the "Model T" equivalent of machine learning looks like?
...
s -->
Every complex machine can fail, sometimes due to [faulty parts](https://www.toyota.com.au/news/toyota-australia-ahead-of-schedule-takata-airbag-recall-expansion), sometimes due to humans who are inside or outside the car.
<!-- s -->
...
<!-- s -->
The hope that this will happen more proactively, rather than reactively -- one hopes that we will do better than reacting to record number of accidents for Road Traffic Act 1934.
...
Finally, one may ask what machine intelligence applications may evolved into, analogous to the diverse style and function landscape of automobiles, e.g., 4-wheel drives, convertibles, SUVs, trucks, vans, buses, or even [road trains](https://en.wikipedia.org/wiki/Road_train)?
